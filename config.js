...
export default {
  ...
  BOT_NAME: process.env.BOT_NAME || "IRFAN-MD",
  MODE: process.env.MODE || "private",
  REPO: process.env.REPO || "https://github.com/JawadTechYT/KHAN-MD",
  WEBPAIR: process.env.WEBPAIR || "https://IRFAN MD-pairx.onrender.com",
  ...
  AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*IRFAN MD VIEWED YOUR STATUS 🤖*",
  ...
  STICKER_NAME: process.env.STICKER_NAME || "IRFAN-MD",
